# Adapted from: https://github.com/ryan112358/private-pgm/blob/1da21c8b38149b05f1385b8e54116568b700b4fa/src/mbi/junction_tree.py
...
class JunctionTree:
    ...
    def set_random_state(self, prng: np.random.RandomState):
        """set the random state for the JunctionTree"""
        self._prng = prng
    ...
    def _greedy_order(self, stochastic=True):
        ...
        for k in range(len(domain)):
            ...
            if stochastic:
                ...
                probas /= probas.sum()
                i = self.prng.choice(probas.size, p=probas)
                a = choices[i]
