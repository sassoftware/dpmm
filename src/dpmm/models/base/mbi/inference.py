# Adapted from: https://github.com/ryan112358/private-pgm/blob/1da21c8b38149b05f1385b8e54116568b700b4fa/src/mbi/inference.py

import numpy as np

# from mbi import Domain
from dpmm.models.base.mbi import GraphicalModel, callbacks, CliqueVector
...
class FactoredInference:
    def __init__(
        ...
        if backend == "torch":
            ...
            from dpmm.models.base.mbi import Factor
    ...
    def _setup(self, measurements, total):  # noqa: C901
        ...
        model = GraphicalModel(
            ...
            cliques,
            total,
            elimination_order=self.elim_order,
            prng=self.prng,
        )
